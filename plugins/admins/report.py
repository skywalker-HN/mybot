...
<b>💳 Cartões vendidos</b> ({nm})
 ...
 <b>💳 Cartões (FULL) vendidos</b> ({nm})
 ├ Valor total das vendas: <b>R$ {round(sold_cards_full[0] or 0, 2)}</b>
 └ Número total de vendas: <b>{sold_cards_full[1] or 0}</b>
 
 <b>💳 Consultaveis vendidas</b> ({nm})
 ├ Valor total das vendas: <b>R$ {round(consul_full[0] or 0, 2)}</b>
 └ Número total de vendas: <b>{consul_full[1] or 0}</b>
